...
//    std::cout << "Initial Solution = " << tspSolver.evaluate(aSolution,tspInstance) << "\n";
//   std::cout << "Final Solution = " << tspSolver.evaluate(bestSolution,tspInstance) << "\n";
//    std::cout << "User Time = " << (double)(tv2.tv_sec+tv2.tv_usec*1e-6 - (tv1.tv_sec+tv1.tv_usec*1e-6)) << "\n";
//    std::cout << "CPU Time = " << (double)(t2-t1) / CLOCKS_PER_SEC << "\n";
